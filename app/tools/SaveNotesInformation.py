...
class SaveNotesInformation(BaseTool):
    ...
    notes_info: List[NoteInfo] = Field(..., description="The notes specific to the conditions listed in the customer's intake. Write a list of notes for each condition by extracting information that would be helpful for the Personal Statement and Nexus Letter.")
    ...
    async def run(self) -> Dict[str, Any]:
        ...
        self._caller_agent.context_info.context.update({
            "notes_information": serializable_notes_info
        })
