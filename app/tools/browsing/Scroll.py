...
from app.tools.browsing.util.selenium import get_web_driver, set_web_driver
    ...
    def run(self):
        ...
        if self.direction == "up":
            if current_scroll_position == 0:
                ...
                result = "Scrolled up by 1 screen height. Make sure to use the AnalyzeContent tool to analyze the page after scrolling."
            ...
            if current_scroll_position + wd.get_window_size()['height'] >= total_scroll_height:
                ...
                wd.execute_script(f"window.scrollBy(0, {height});")
                result = "Scrolled down by 1 screen height. Make sure to use the AnalyzeContent tool to analyze the page after scrolling."
