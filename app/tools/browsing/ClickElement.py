...
from app.tools.browsing.util import get_b64_screenshot
from app.tools.browsing.util import get_web_driver, set_web_driver
from app.tools.browsing.util.highlights import highlight_elements_with_labels, remove_highlight_and_labels
...
DOM structure of the page.""".replace("\n", ""),
        ...
        while True:
            ...
            try:
                ...
                if error_count > 3:
                    result = f"Error clicking element. Error: {message} To further analyze the page, use the AnalyzeContent tool. Once you have found the information you are looking for, you will use the 'ReadPageText' or 'ReadPDF' tool to gather the contents of the page or PDF for analysis to read and understand the actual contents to report or write a summary of the page."
                    break
