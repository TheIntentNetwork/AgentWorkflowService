...
from app.utilities.schema import reference_schema
...
class ToolSchema:
    ...
    def from_langchain_tools(tools: List):
        """
        Converts a list of langchain tools into a list of Tools.
        :param tools: A list of langchain tools.
        :return: A list of Tools.
        """
        converted_tools = []
        for tool in tools:
            converted_tools.append(ToolSchema.from_langchain_tool(tool))
    ...
    def from_langchain_tool(tool):
        """
        Converts a langchain tool into a Tool.
    ...
    def from_openai_schema(schema: Dict[str, Any], callback: Any):
        """
        Converts an OpenAI schema into a Tool. Nested propoerties without refs are not supported yet.
        :param schema:
        :param callback:
        :return:
        """
    ...
    def from_openapi_schema(schema: Union[str, dict], headers: Dict[str, str] = None, params: Dict[str, Any] = None):
        ...
        for path, methods in openapi_spec["paths"].items():
            for method, spec_with_ref in methods.items():
                ...
                tools.append(ToolSchema.from_openai_schema(function, callback))

        return tools
        
    @staticmethod
    def from_file(file_path: str):
        """Dynamically imports a class from a Python file, ensuring Tool itself is not imported."""
